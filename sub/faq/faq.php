...
<main>
  <h2>1:1문의</h2>
    <a href="faq_write.php">작성하기</a>
    <ul>
      <?php
        $sql_faq = "select * from board_question order by question_id desc limit 8";
        ...
        ?>
          <ul>
            <li><a href="faq_view.php?question_id=<?=$data['question_id']?>"><?=$data['question_title']?></a></li>
            <li>
