...
<main>
  ...
  <div id="search">
    ...
    <ul class="tag">
      <li><a href="<?=$base_URL?>sub/search/search_academy.php" data-tag="입문자" title="">#입문자</a></li>
      <li><a href="<?=$base_URL?>sub/search/search_academy.php"  data-tag="일상" title="">#일상</a></li>
      <li><a href="<?=$base_URL?>sub/search/search_academy.php"  data-tag="피크닉" title="">#피크닉</a></li>
      <li><a href="<?=$base_URL?>sub/search/search_academy.php"  data-tag="야경사진" title="">#야경사진</a></li>
      <li><a href="<?=$base_URL?>sub/search/search_academy.php"  data-tag="전문가" title="">#전문가</a></li>
    </ul>
