      ...
      <form action="adm_member_search.php" method="get">
        ...
        <div class="s_wrap">
          ...
          <select name="category" id="category">
            ...
            <option value="mb_name" <?=$category=="mb_name" ? "selected" : ""?>>이름</option>
            <option value="mb_id" <?=$category=="mb_id" ? "selected" : ""?>>아이디</option>
            <option value="mb_email" <?=$category=="mb_email" ? "selected" : ""?>>이메일</option>
            <option value="mb_tel" <?=$category=="mb_tel" ? "selected" : ""?>>전화번호</option>
          </select>
