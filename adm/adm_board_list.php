    ...
    <div id="tab1" class="tab_content active">
      <form action="" method="post" name="">
        <table>
          ...
          $sql = "select * from board_notice limit $start, $list_num;"; /* paging : 쿼리 작성 - limit 몇번부터, 몇개 */
        ...
        <div class="pagination">
          ...
          <?php
            if($page <= 1){
          ?>
            <a href="?page=1" title="prev" class="prev"><i class="fa-solid fa-chevron-left"></i></a>
            <?php } else{ ?>
            <a href="?page=<?php echo ($page-1); ?>" title="prev" class="prev"><i class="fa-solid fa-chevron-left"></i></a>
            <?php }?>

            <?php
            for($print_page = $s_pageNum; $print_page <= $e_pageNum; $print_page++){
            ?>
            <li><a href="?page=<?php echo $print_page; ?>" title=""><?php echo $print_page; ?></a></li>
            <?php }?>

            <?php
            if($page >= $total_page){
            ?>
            <a href="?page=<?php echo $total_page; ?>" title="next" class="next"><i class="fa-solid fa-chevron-right"></i></a>
            <?php } else{ ?>
            <a href="?page=<?php echo ($page+1); ?>" title="next" class="next"><i class="fa-solid fa-chevron-right"></i></a>
          </ul>
        </div>
        <?php }?>
      </form>
    ...
    <div id="tab3" class="tab_content">
      <form action="" method="post" name="">
        ...
        <colgroup>
          ...
          <?php
          $sql = "select * from board_community;";
          $result = mysqli_query($con, $sql);
